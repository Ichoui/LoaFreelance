...
<main class="page projet">
   <section class="container">
      ...
      if($statut == "IN_SEARCH")
      {
        echo'
        <!-- Large modal -->
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">Démarrer le projet</button>
           ...
           <div class="modal-dialog modal-lg">
              <div class="modal-content">
                 <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ajouter un jalon <button id="add_jalon" type="button" class="btn btn-primary">+</button></h5>
                 ...
                 <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Lancer Projet</button>
                    </form>
                 </div>
              </div>
           </div>
